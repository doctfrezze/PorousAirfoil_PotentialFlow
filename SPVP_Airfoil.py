...
def SPVP(XB, YB,numPan,Vinf,AoA,rhoinf=1,Delta_Cp=0,Rs=1,a=1,n=1,pore_entry=[],pore_out=[],omega_in=0,omega_out=0):
    ...
    b = COMPUTE_b_SPVP(numPan,Vinf,beta,rhoinf,Delta_Cp,Rs,a,n,pore_entry,pore_out,omega_in,omega_out)
    lam, gamma = COMPUTE_SOLUTION_SPVP(A,b)

    # COMPUTE PANEL VELOCITIES AND PRESSURE COEFFICIENTS
    Vt, Cp = COMPUTE_Vt_Cp(numPan,Vinf,beta,lam,gamma,J,L,rhoinf,Delta_Cp,Rs,a,n,pore_entry,pore_out,omega_in,omega_out,b)
