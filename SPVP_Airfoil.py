...
def generate_naca4(m, p, t, c=1.0, n=100):
...
XB, YB = generate_naca4(0.02,0.4,0.12,n=101)
...
if (flagPlot[4] == 1 or flagPlot[5] == 1):                                      # If we are plotting streamlines or Cp contours
    ...
    print("Sum of L     : %2.8f" % sum(lam*S))                                  # Print sum of source strengths
    print("Sum of G     : %2.8f" % sum(gamma*S))                                # Print sum of vortex strengths
