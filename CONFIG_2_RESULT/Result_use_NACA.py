...
df = pd.read_csv("CONFIG_2_RESULT/resultats_simulations_Airfoil1.csv")
...
#%% Case 2
# Lecture du fichier CSV
df = pd.read_csv("CONFIG_2_RESULT/resultats_simulations_Airfoil2.csv")
...
#%% Case 3
# Lecture du fichier CSV
df = pd.read_csv("CONFIG_2_RESULT/resultats_simulations_Airfoil3.csv")
