...
if __name__ == "__main__":
    ...
    while err > tol and iter < max_iter: 
        ...
        Cp,lam,gamma,CL,CM = SPVP(Fluid_characteristics,Airfoil_geometry,Pore_characteristics,is_porous = 1,Delta_Cp=Delta_Cp)
    ...
    PLOT_AIRFOIL(XB,YB,pore_entry,pore_exit,alone=0)
